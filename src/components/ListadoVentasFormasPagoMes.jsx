...
export default function ListadoVentasFormasPagoMes() {
		...
		<div className='space-y-2'>
			...
			<div className='md:flex space-y-3 md:space-y-0 gap-4'>
				<div className='overflow-x-auto w-full'>
					<Table striped>
						<Table.Head>
							<Table.HeadCell colSpan={3}>Formas de pago</Table.HeadCell>
						</Table.Head>
						<Table.Head>
						...
						<Table.Body className='divide-y'>
							{Object.values(cierreMes.total_ventas_by_forma_pago).map(
								(venta, i) => (
									<Table.Row
										key={i}
